function fn() {
    ...
    const rootUrlDev = 'http://localhost:8038/';
    const adminCredentialsDev = {"username": "admin","password": "123"};
    const urlDev = 'jdbc:mysql://localhost:3306/ms2_test';
    ...
    const urlInit = 'jdbc:mysql://localhost:8038/peps-order';
    ...
    const urlE2e = 'jdbc:mysql://localhost:8038/peps-order';
